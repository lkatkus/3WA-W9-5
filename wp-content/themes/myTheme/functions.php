...
// ------ CUSTOMIZED CODE ------
    ...
    // MENU LOCATION MUST REGISTRATION FIRST. NAVIGATION MUST BE REGISTERED BEFORE THEY ARE USED.
    register_nav_menus(
    ...
    // SETTING UP EXACT NAVIGATION. EACH NAVIGATION SHOULD BE SET
    ...
    wp_enqueue_style('myCSS'); // OUTPUTTING THE CSS TO WP_HEAD
